...
<table id="summary_block_table">
    ...
    <tr>
        <td>Details</td>
        <td><?php echo esc_attr( $leadView->customer_upload_images ); ?></td>
    </tr>
</table>
    ...
    <table>
        <caption>Lead sheet
            <span class="cursorPointer"><a
                        href="admin.php?page=fsms_work_leads&action=lead_sheet&id=<?php echo esc_attr( $leadView->id ); ?>">Edit</a></span>
        </caption>
        <tr>
            <td>Lead sheet</td>
