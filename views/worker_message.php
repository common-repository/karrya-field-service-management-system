...
<?php foreach ( $allmessagesParentWorker as $allmessageParent ):
    ...
    <div>
        ...
        <span class='cursorPointer replyMessage' onclick="messageReplyWorker(<?php echo esc_attr( $allmessageParent->id ); ?>);">Reply</span>
        <div>
