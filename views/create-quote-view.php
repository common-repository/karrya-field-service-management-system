    ...
    <div id="invoiceDiv">
        ...
        <div class="invoiceBlock">
            <div class="invoiceDetails">
                <div class="invoiceTextId">Quote: #<?php echo esc_attr( $leadView->id ); ?></div>
                <div class="invoiceTextDate">Quote date: <?php echo date( "Y-m-d" ); ?></div>
            </div>
            <table width="100%" class="chargeSummaryBlcokClz">
                ...
                foreach ( $leadCharges as $leadCharge ):
					...
					if ( $leadCharge->entry_category == "charge" && $leadCharge->is_add_to_quote == 1 ) {
						$qty = $leadCharge->qty;
						if ( $qty == 0 ) {
							$qty = 1;
						}
						...
						$is_publish_to_quote = $leadCharge->is_publish_to_quote;

						if ( $is_publish_to_quote == 1 or $is_publish_to_quote == 2 or $is_publish_to_quote == 4 ) {
							$row_id ++;
					...
					if ( $leadCharge->entry_category == "nonCharge" && $leadCharge->is_add_to_quote == 1 ) {
						?>
                        <tr>
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" id="send_to_email_subject" name="send_to_email_subject"
                           value="<?php echo esc_attr( "Quote #" . $leadView->id ); ?>" placeholder="Email subject">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <input type="button" name="" id="send_quote" class="saveBtn" value="Send quote">
